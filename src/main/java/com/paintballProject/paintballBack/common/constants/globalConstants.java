package com.paintballProject.paintballBack.common.constants;
...
public class globalConstants {
    ...
    public static final String ENDPOINT_NEWS = "/api/news";
    public static final String ENDPOINT_CATEGORY = "/api/category";
